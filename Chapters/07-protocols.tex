...
The experimenter can also infer the statistics $p(m_k\thinspace\vert\thinspace M_i, P_0)$ from the correlations $p((m_k,m_l)\thinspace\vert\thinspace(M_i,M_j),P_0)$:
\begin{equation*}
