...
\begin{equation*}
\sum_{i=1}^n X_{ii} = \sum_{i=1}^n \vert \langle u'_i\vert u_0\rangle \vert^2 = \sum_{i=1}^n\operatorname{tr}(\Pi_{\text{relevant}}^{(1\vert i)}\rho_0)+\mathcal{O}(n\thinspace d^{5/2}\epsilon^{1/2}\mathcal{X}^{-1/2}).
\end{equation*}
